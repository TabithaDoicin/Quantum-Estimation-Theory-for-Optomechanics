...
k = 2e5
d0 = 1.1e7
g0_list = np.linspace(200,200.00001,2)
g2_list = np.linspace(100,100.0001,2)
n = 237.54
min_ep = 3.88e9
max_ep = 1.64e11
ep_list = np.linspace(1e8,3.8e9,150)
...
#print(m.efficient_solver(wm, gm, k, d0, g0_list[0], ep_list[0], g2_list[0], n, recalib = False, checks = True))